...
export default function currentPlugin(
  state: currentPluginType = initialState.currentPlugin,
  action: actionType,
) {
  switch (action.type) {
    case START_RUNNING:
    ...
    case SELECT_PLUGIN:
      ...
      return { id: action.payload, params: undefined, isRunning: false };
